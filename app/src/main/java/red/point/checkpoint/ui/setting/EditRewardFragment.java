 ...
 */
public class EditRewardFragment extends DialogFragment {

    private static final String TAG = EditRewardFragment.class.getSimpleName();

    @Inject PrefManager prefManager;
    @Inject SettingService settingService;

    @BindView(R.id.reward) EditText mEditText;
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_edit_reward, null);
        ...
        editSettingComponent.injectEditReward(this);
        ...
        mEditText.setText(String.format("%s", setting.getReward()));
