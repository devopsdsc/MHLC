...
import red.point.checkpoint.ui.pin.report.DaggerPinReportComponent;
import red.point.checkpoint.ui.pin.report.PinDailyReportFragment;
import red.point.checkpoint.ui.pin.report.PinReportComponent;
import red.point.checkpoint.ui.pin.report.PinReportFragment;
import red.point.checkpoint.ui.pin.report.PinReportModule;
...
public class MyPinReportFragment extends MainFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pinReportComponent.inject(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            {
                FragmentHelper.replace(getActivity(), new MyPinReportFragment(), null, false);
            }
        }
