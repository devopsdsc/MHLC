 ...
 */
public class EditCheckInRadiusFragment extends DialogFragment {

    @Inject PrefManager prefManager;
    @Inject SettingService settingService;

    @BindView(R.id.checkin_radius) EditText mEditText;

    private Unbinder unbinder;
    private Call<SettingResponse> settingCall;

    public EditCheckInRadiusFragment() {}

    @Override
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_edit_checkin_radius, null);
        ...
        editSettingComponent.injectEditCheckInRadius(this);
        ...
        mEditText.setText(String.format("%s", setting.getCheckInRadius()));
