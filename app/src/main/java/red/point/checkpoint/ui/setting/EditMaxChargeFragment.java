 ...
 */
public class EditMaxChargeFragment extends DialogFragment {

    @Inject PrefManager prefManager;
    @Inject SettingService settingService;

    @BindView(R.id.maxCharge) EditText mEditText;

    private Unbinder unbinder;
    private Call<SettingResponse> settingCall;

    public EditMaxChargeFragment() {}

    @Override
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_edit_max_charge, null);
        ...
        editSettingComponent.injectEditMaxCharge(this);
        ...
        mEditText.setText(String.format("%s", setting.getMaxCharge()));
